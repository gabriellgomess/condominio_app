  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-8">
        <div className={`card p-6 text-center animate-fade-in ${isDarkMode ? 'bg-gray-800/50' : 'bg-white/80'} border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`} style={{ animationDelay: '0.1s' }}>
        ...
        <div className={`card p-6 text-center animate-fade-in ${isDarkMode ? 'bg-gray-800/50' : 'bg-white/80'} border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`} style={{ animationDelay: '0.2s' }}>
          ...
          <div className={isDarkMode ? 'text-[#f3f7f1]' : 'text-gray-700'}>Usuários</div>
        </div>

        <div className={`card p-6 text-center animate-fade-in ${isDarkMode ? 'bg-gray-800/50' : 'bg-white/80'} border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`} style={{ animationDelay: '0.3s' }}>
          ...
          <div className={isDarkMode ? 'text-[#f3f7f1]' : 'text-gray-700'}>Relatórios</div>
        </div>

        <div className={`card p-6 text-center animate-fade-in ${isDarkMode ? 'bg-gray-800/50' : 'bg-white/80'} border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`} style={{ animationDelay: '0.4s' }}>
          ...
          <div className={isDarkMode ? 'text-[#f3f7f1]' : 'text-gray-700'}>Disponível</div>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        {/* Condomínios */}
        <div className={`card p-8 animate-fade-in ${isDarkMode ? 'bg-gray-800/50' : 'bg-white/80'} border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`} style={{ animationDelay: '0.5s' }}>
        ...
        {/* Usuários */}
        <div className={`card p-8 animate-fade-in ${isDarkMode ? 'bg-gray-800/50' : 'bg-white/80'} border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`} style={{ animationDelay: '0.6s' }}>
          <div className="flex items-center space-x-3 mb-6">
      ...
      <div className="mt-12 animate-fade-in" style={{ animationDelay: '0.9s' }}>
        ...
        <div className={`card p-6 ${isDarkMode ? 'bg-gray-800/50' : 'bg-white/80'} border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
          <div className="space-y-4">
            <div className={`flex items-center space-x-4 p-4 ${isDarkMode ? 'bg-[#080d08]/40' : 'bg-gray-50/80'} rounded-lg border ${isDarkMode ? 'border-[#ff6600]/20' : 'border-gray-200'}`}>
              <div className="w-3 h-3 bg-[#ff6600] rounded-full animate-pulse"></div>
              <div className="flex-1">
                <p className={`${isDarkMode ? 'text-white' : 'text-gray-900'} font-medium`}>Novo condomínio criado</p>
                <p className={`${isDarkMode ? 'text-[#f3f7f1]' : 'text-gray-600'} text-sm`}>Condomínio "Residencial Verde" foi adicionado ao sistema</p>
              </div>
            ...
            <div className={`flex items-center space-x-4 p-4 ${isDarkMode ? 'bg-[#080d08]/40' : 'bg-gray-50/80'} rounded-lg border ${isDarkMode ? 'border-[#ff6600]/20' : 'border-gray-200'}`}>
              ...
              <div className="flex-1">
                <p className={`${isDarkMode ? 'text-white' : 'text-gray-900'} font-medium`}>Usuário atualizado</p>
                <p className={`${isDarkMode ? 'text-[#f3f7f1]' : 'text-gray-600'} text-sm`}>Permissões do usuário "João Silva" foram modificadas</p>
              </div>
            ...
            <div className={`flex items-center space-x-4 p-4 ${isDarkMode ? 'bg-[#080d08]/40' : 'bg-gray-50/80'} rounded-lg border ${isDarkMode ? 'border-[#ff6600]/20' : 'border-gray-200'}`}>
              ...
              <div className="flex-1">
                <p className={`${isDarkMode ? 'text-white' : 'text-gray-900'} font-medium`}>Relatório gerado</p>
                <p className={`${isDarkMode ? 'text-[#f3f7f1]' : 'text-gray-600'} text-sm`}>Relatório mensal de ocupação foi exportado</p>
              </div>

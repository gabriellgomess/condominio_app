    ...
    >
      ...
      <div className="mb-8 animate-fade-in">
        <h2 className="text-4xl font-bold text-white mb-4">
          Olá, <span className="text-[#3dc43d]">Administrador</span>! 👋
        </h2>
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-8">
        <div className="card p-6 text-center animate-fade-in" style={{ animationDelay: '0.1s' }}>
          <div className="w-16 h-16 bg-gradient-to-br from-[#3dc43d] to-green-500 rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse-slow">
            <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
            </svg>
          </div>
          <div className="text-3xl font-bold text-[#3dc43d] mb-2">12</div>
        ...
        <div className="card p-6 text-center animate-fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="text-3xl font-bold text-[#3dc43d] mb-2">156</div>
        ...
        <div className="card p-6 text-center animate-fade-in" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="text-3xl font-bold text-[#3dc43d] mb-2">89</div>
        ...
        <div className="card p-6 text-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="text-3xl font-bold text-[#3dc43d] mb-2">24/7</div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="card p-8 animate-fade-in" style={{ animationDelay: '0.5s' }}>
          <div className="flex items-center space-x-3 mb-6">
            <div className="w-12 h-12 bg-gradient-to-br from-[#3dc43d] to-green-500 rounded-xl flex items-center justify-center">
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-3 text-[#f3f7f1]">
              <div className="w-2 h-2 bg-[#3dc43d] rounded-full"></div>
      ...
      <div className="mt-12 animate-fade-in" style={{ animationDelay: '0.9s' }}>
        ...
        <div className="card p-6">
          <div className="space-y-4">
            <div className="flex items-center space-x-4 p-4 bg-[#080d08]/40 rounded-lg border border-[#3dc43d]/20">
              <div className="w-3 h-3 bg-[#3dc43d] rounded-full animate-pulse"></div>
              ...
              <span className="text-[#3dc43d] text-sm">2 min atrás</span>
            </div>
            ...
            <div className="flex items-center space-x-4 p-4 bg-[#080d08]/40 rounded-lg border border-[#3dc43d]/20">
              ...
              <span className="text-[#3dc43d] text-sm">15 min atrás</span>
            </div>
            ...
            <div className="flex items-center space-x-4 p-4 bg-[#080d08]/40 rounded-lg border border-[#3dc43d]/20">
              ...
              <span className="text-[#3dc43d] text-sm">1 hora atrás</span>
            </div>
          </div>
        </div>
      </div>

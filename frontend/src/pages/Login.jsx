  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#080d08] via-[#0a0f0a] to-[#080d08] relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-[#3dc43d]/12 rounded-full blur-3xl animate-float" style={{ animationDelay: '6s' }}></div>
        ...
        <div className="w-full max-w-md">
          <div className="glass-panel p-8 animate-scale-in">
            ...
            <div className="text-center mb-8">
              ...
              <div className="h-1 w-16 bg-gradient-to-r from-[#3dc43d] to-[#06e006] mx-auto rounded-full mb-4 animate-glow"></div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="animate-slide-up" style={{ animationDelay: '0.3s' }}>
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <Mail className="h-5 w-5 text-[#3dc43d] group-focus-within:text-[#06e006] transition-colors duration-300" />
                  </div>
                  <input
                    id="email"
                    type="email"
                    ...
                    required
                    className="w-full pl-12 pr-4 py-4 bg-[#080d08]/40 backdrop-blur-sm border border-[#3dc43d]/20 rounded-xl text-[#f3f7f1] placeholder-[#3dc43d]/50 focus:outline-none focus:ring-2 focus:ring-[#3dc43d]/50 focus:border-[#3dc43d]/50 transition-all duration-300 hover:border-[#3dc43d]/40 hover:bg-[#080d08]/60"
              ...
              <div className="animate-slide-up" style={{ animationDelay: '0.4s' }}>
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <Lock className="h-5 w-5 text-[#3dc43d] group-focus-within:text-[#06e006] transition-colors duration-300" />
                  </div>
                  <input
                    id="password"
                    type="password"
              ...
              <div className="glass-card p-6">
                <div className="flex items-center mb-4">
                  <div className="w-8 h-8 glass-icon rounded-lg flex items-center justify-center mr-3">
                    <Info className="w-4 h-4 text-[#3dc43d]" />
                  </div>
                  <h3 className="text-lg font-semibold text-[#3dc43d]">Usuários para teste</h3>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-[#080d08]/30 rounded-lg border border-[#3dc43d]/10 hover:border-[#3dc43d]/20 transition-colors duration-300">
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#3dc43d] rounded-full mr-3"></div>
                      <span className="text-[#f3f7f1] font-medium">Admin</span>
                    </div>
                    <span className="font-mono text-xs text-[#3dc43d]/80">admin@condominio.com</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-[#080d08]/30 rounded-lg border border-[#3dc43d]/10 hover:border-[#3dc43d]/20 transition-colors duration-300">
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#06e006] rounded-full mr-3"></div>
                      <span className="text-[#f3f7f1] font-medium">Síndico</span>
                    </div>
                    <span className="font-mono text-xs text-[#3dc43d]/80">sindico@condominio.com</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-[#080d08]/30 rounded-lg border border-[#3dc43d]/10 hover:border-[#3dc43d]/20 transition-colors duration-300">
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#3dc43d]/70 rounded-full mr-3"></div>
                      <span className="text-[#f3f7f1] font-medium">Morador</span>
                    </div>
                    <span className="font-mono text-xs text-[#3dc43d]/80">morador@condominio.com</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-[#080d08]/30 rounded-lg border border-[#3dc43d]/10 hover:border-[#3dc43d]/20 transition-colors duration-300">
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#06e006]/70 rounded-full mr-3"></div>
                      <span className="text-[#f3f7f1] font-medium">Funcionário</span>
                    </div>
                    <span className="font-mono text-xs text-[#3dc43d]/80">funcionario@condominio.com</span>
                  </div>
                </div>
                <div className="mt-4 p-3 bg-[#3dc43d]/10 rounded-lg border border-[#3dc43d]/20">
                  <p className="text-xs text-[#3dc43d] text-center font-medium">

    ...
    >
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-8">
        <div className="card p-6 text-center">
          <div className="text-3xl font-bold text-[#04d404] mb-2">{condominiums.length}</div>
          <div className="text-[#f3f7f1]">Total</div>
        </div>
        <div className="card p-6 text-center">
          <div className="text-3xl font-bold text-[#04d404] mb-2">
        ...
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex space-x-2">
              <input
                ...
                className="px-4 py-2 bg-[#080d08]/80 border border-[#04d404]/30 rounded-lg text-white placeholder-[#04d404]/60 focus:outline-none focus:ring-2 focus:ring-[#04d404] focus:border-transparent"
              />
              <select className="px-4 py-2 bg-[#080d08]/80 border border-[#04d404]/30 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#04d404] focus:border-transparent">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b border-[#04d404]/20">
                  <th className="text-left py-3 px-4 text-[#04d404] font-medium">Nome</th>
                  <th className="text-left py-3 px-4 text-[#04d404] font-medium">Endereço</th>
                  <th className="text-left py-3 px-4 text-[#04d404] font-medium">Unidades</th>
                  <th className="text-left py-3 px-4 text-[#04d404] font-medium">Blocos</th>
                  <th className="text-left py-3 px-4 text-[#04d404] font-medium">Status</th>
                  <th className="text-left py-3 px-4 text-[#04d404] font-medium">Criado em</th>
                  <th className="text-left py-3 px-4 text-[#04d404] font-medium">Ações</th>
                </tr>
              </thead>
              <tbody>
                {condominiums.map((condominium) => (
                  <tr key={condominium.id} className="border-b border-[#04d404]/10 hover:bg-[#04d404]/5 transition-colors">
                    ...
                    <td className="py-4 px-4">
                      <div className="flex space-x-2">
                        <button className="p-2 text-[#04d404] hover:bg-[#04d404]/20 rounded-lg transition-colors">

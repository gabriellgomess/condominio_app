    ...
    >
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-8">
        <div className="card p-6 text-center">
          <div className="text-3xl font-bold text-[#ff6600] mb-2">{condominiums.length}</div>
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex space-x-2">
              <input
                ...
                className="px-4 py-2 bg-[#080d08]/80 border border-[#ff6600]/30 rounded-lg text-white placeholder-[#ff6600]/60 focus:outline-none focus:ring-2 focus:ring-[#ff6600] focus:border-transparent"
              />
              <select className="px-4 py-2 bg-[#080d08]/80 border border-[#ff6600]/30 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#ff6600] focus:border-transparent">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[#ff6600]/20">
                  ...
                  <th className="text-left py-3 px-4 text-[#ff6600] font-medium">Criado em</th>
              ...
              <tbody>
                {condominiums.map((condominium) => (
                  <tr key={condominium.id} className="border-b border-[#ff6600]/10 hover:bg-[#ff6600]/5 transition-colors">
                    ...
                    <td className="py-4 px-4">
                      <div className="flex space-x-2">
                        <button className="p-2 text-[#ff6600] hover:bg-[#ff6600]/20 rounded-lg transition-colors">
